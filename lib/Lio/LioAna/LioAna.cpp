...
*/
LioAnaIn::LioAnaIn(uint8_t pin, int LO_DEF, int HI_DEF, double LO_LIM, double HI_LIM, double offset)
:   m_pin (pin),
    m_LO_DEF(LO_DEF),
    m_HI_DEF(HI_DEF),
    m_LO_LIM(LO_LIM),
...
double LioAnaIn::scale(double val, double LO_LIM, double HI_LIM)
{
...
void LioAnaIn::main()
{
    ...
    m_val = scale((double)value, m_LO_LIM, m_HI_LIM);
}
